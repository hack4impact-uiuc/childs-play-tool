            ...
            <Row>
                <Row>
                    ...
                    <Col>
                        ...
                        <img src={require("../styles/agecategories.png")} alt="Anxiety/Hyperactivity, Bored (Long Term), Bored (Short Term), Cognitive Impairment, Pain, Sadness" height="200px"></img>
                    </Col>
                </Row>
                <Row>
                    <Col>
