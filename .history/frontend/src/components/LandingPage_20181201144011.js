        ...
        <h3 className="homeText2L">
            ...
            <Row>
                ...
                <h2 className="subtitles">
                    ...
                    <p>
                        Tap on the vertical ellipsis (three dots) button on the right to reveal more options, then select "Add to Home Screen." 
                ...
                <Col>
                    ...
                    <p>
                        Select the URL at the top to highlight it. At the bottom of the screen, tap the share icon. Select "Add to Home Screen."
                    </p>
                </Col>
            </Row>
        </Container>
