        ...
        <h3 className="homeText2L">
            ...
            <Row>
                <Col>
                    ...
                    <img src="https://ffp4g1ylyit3jdyti1hqcvtb-wpengine.netdna-ssl.com/firefox/files/2017/12/firefox-logo-300x310.png" alt="Anxiety/Hyperactivity, Bored (Long Term), Bored (Short Term), Cognitive Impairment, Pain, Sadness" height="42" width="42"></img>
                </Col>
                <Col>
                    <p>
                    ...
                    <Media object data-src="searchimage.png" alt="Search page"></Media>
                </Col>
            </Row>
        </Container>
