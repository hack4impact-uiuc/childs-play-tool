        ...
        <h3 className="homeText2L">
            ...
            <Row>
                <Col>
                    ...
                    <img src={require("../styles/symptomimage.png")} alt="Anxiety/Hyperactivity, Bored (Long Term), Bored (Short Term), Cognitive Impairment, Pain, Sadness" height="42" width="42"></img>
                </Col>
                <Col>
                    <p>
                    ...
                    <img src={require("../styles/searchimage.png")} alt="Search page"></img>
                </Col>
            </Row>
        </Container>
