...
export const LandingPageStrings = {
  ...
  tutorial1: "Searching for game recommendations by name will simply return ALL games that contain the given name. Type the name into the following input field:",
  tutorial2: "To search for game recommendations, you must select one of the six symptom categories:",
  tutorial3: "You must also select one of the age groups:",
  tutorial4: "It is optional to select a game console and the gender of the main character. The search will return all games that match the specifications.",
  tutorial5: "Each game has labels that describe its intended age group, applicable symptoms, and gender of the main character.",
  tutorial6: "After performing a search, there is the option to save its results at the bottom of the results page. Be sure to provide a descriptive name that will help you identify it for later viewing.",
  tutorial7: "Load a saved search at the bottom of the search page to view the previously saved game recommendations.",
  mobileGuideHeader: "Saving this Guide as a Mobile App",
  android: "Android",
  androidDesc: "Tap on the vertical ellipsis (three dots) button on the right to reveal more options. Select \"Add to Home Screen.\" A pop up will appear, tap on \"Add\" to proceed. Confirm the website's addition to your home screen, and it will show you a preview of its shortcut icon. You can select the location now or move it later.",
  iOS: "iOS",
  iOSDesc: "Select the URL at the top to highlight it. At the bottom of the screen, tap the share icon. Tap the icon labeled \"Add to Home Screen.\" Tap Add in the upper-right corner.",
  aboutHeader: "About Child's Play",
  aboutDesc: "Child's Play is a game industry charity dedicated to improving the lives of children with toys and games in a network of over 150 hospitals worldwide.",
